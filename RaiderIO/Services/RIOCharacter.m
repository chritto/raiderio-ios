...
{
  return [NSString stringWithFormat:@"%@ - \n\t name: %@; \n\t race: %@; \n\t characterClass: %@; \n\t activeSpecName: %@; \n\t activeSpecRole: %@; \n\t gender: %@; \n\t faction: %@; \n\t achievementPoints: %lld; \n\t honorableKills: %lld; \n\t thumbnailURL: %@; \n\t region: %@; \n\t realm: %@; \n\t profileURL: %@; \n\t guild: %@; \n", [super description], _name, _race, _characterClass, _activeSpecName, _activeSpecRole, _gender, _faction, (long long)_achievementPoints, (long long)_honorableKills, _thumbnailURL, _region, _realm, _profileURL, _guild];
}

- (NSUInteger)hash
{
  NSUInteger subhashes[] = {[_name hash], [_race hash], [_characterClass hash], [_activeSpecName hash], [_activeSpecRole hash], [_gender hash], [_faction hash], ABS(_achievementPoints), ABS(_honorableKills), [_thumbnailURL hash], [_region hash], [_realm hash], [_profileURL hash], [_guild hash]};
